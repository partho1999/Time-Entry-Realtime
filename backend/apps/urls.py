...
from .views import RunAIView, PersonCreateAPIView, PersonDetailAPIView, CameraCreateAPIView, CameraDetailAPIView,  LoginHistoryCreateAPIView, LoginHistoryFilteredAPIView
